  ...
  return (
    <section>
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(90deg, #252B42, #00000026), url(${processedBannerBg || "https://via.placeholder.com/150"})`,
      ...
      <div className="banner_bottom bg-[#064a9b1A] py-3 md:py-5">
