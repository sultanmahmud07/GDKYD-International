   ...
   <div className="p-5 md:p-10 md:px-14 my-3 md:my-6 main_container bg-secondary rounded-md">
     <div className="flex items-center flex-col md:flex-row gap-2 md:gap-5">
       <div className="w-full md:w-2/3">
         ...
         <p className="text-sm md:text-base text-white my-2">Join the  {"Join our growing community and stay updated on KYD’s latest innovations and industry insights. Sign up now to receive exclusive updates straight to your inbox!"}</p>
       </div>
